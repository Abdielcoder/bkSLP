...
document.querySelectorAll("input.form_input").forEach(e => { 
    e.addEventListener("keyup", t => { toggleInputOutline(t.target, null) });
    e.addEventListener("click", t => { toggleInputOutline(t.target, null) });
}); 
...
const verifyPreAccess = () => {
    ...
    if((login_email.value === "" || isEmail === false) && login_password.value === "") {
